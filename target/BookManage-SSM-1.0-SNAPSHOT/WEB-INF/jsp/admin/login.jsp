...
<div id="box">
    ...
    <div id="info">
        <form method="post" action="${pageContext.request.contextPath}/admin/loginAdmin" id="registerFrom">
            <div style="color: red;"><span id="s_username" class="error"></span></div>
            <input type="text" class="form-control" id="username" name="name" placeholder="账号:">
