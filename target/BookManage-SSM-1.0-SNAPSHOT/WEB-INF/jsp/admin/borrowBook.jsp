...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4 column">
            <a class="btn btn-primary" href="${pageContext.request.contextPath}/admin/userBook">显示全部借阅书籍</a>
        </div>
            ...
            <table class="table table-hover table-striped">
                ...
                <c:forEach var="book"  items="${pageInfo.list}">
                    <tr>
                        ...
                        <td>${book.count}</td>
                        <td>
                            <a href="${pageContext.request.contextPath}/borrowBook/return?bookName=${book.bookName}" class="btn btn-success">归还</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
